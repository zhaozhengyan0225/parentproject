	...
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld">
			<a href="/" hidefocus="true"> 
				<b></b>
				<img src="/images/XBB2.png" width="270" height="60" alt="新巴巴">
			</a>
		</div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="settleup-2013">
			<dl>
				<dt class="ld">
					<span class="shopping"> <span id="shopping-amount">3</span>
					</span> <a href="/cart/cart.html" id="settleup-url">去购物车结算</a>
				</dt>
				<!--
				<dd>
					<div class="prompt">
